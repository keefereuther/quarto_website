...
1. [Can Humans Choose Randomly?](bild_5-labs/coding-01-can-humans-choose-randomly.qmd)
2. [Run Your First Line of Code](bild_5-labs/coding-02-run-your-first-line-of-code.qmd)
3. [Visualize Penguins with ggplot2](bild_5-labs/coding-03-visualize-penguins.qmd)
4. [Wrangle Penguins with dplyr](bild_5-labs/coding-04-wrangle-penguins.qmd)
5. [Read, Fix, and Test R Errors](bild_5-labs/coding-05-read-fix-and-test-r-errors.qmd)
6. [Check Assumptions Before a Parametric Test](bild_5-labs/coding-06-check-assumptions.qmd)
7. [Compare Two Means with t-tests](bild_5-labs/coding-07-run-t-tests.qmd)
8. [Compare Several Means with ANOVA](bild_5-labs/coding-08-run-anova.qmd)
9. [Correlation and Linear Regression](bild_5-labs/coding-09-correlation-and-regression.qmd)
