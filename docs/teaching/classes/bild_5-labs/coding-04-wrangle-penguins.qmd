...
## 9. Recap — functions you practiced
...
The assignment also asks you to build a boxplot with `reorder()` so groups sort by elevation. You learned ggplot layering in **Coding Activity 3**; on Canvas you combine that with the joined table you prepare here.
