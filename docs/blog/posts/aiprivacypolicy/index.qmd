...
date: "2024-10-16"
image: "security.webp"
image-alt: "Padlock icon representing data security and privacy"
format: 
  html:
    page-layout: full
---
...
-   **Opt Out of Data Usage for Training**:
    -   For **ChatGPT**, follow the opt-out instructions below.
        ...
        -   ![Screenshot showing ChatGPT settings menu to opt out of data usage for model training — step 1](privacy1.png)

        -   ![Screenshot showing ChatGPT data controls toggle to disable model training — step 2](privacy2.png)
